...
def login_page():
    ...
    <style>
        ...
        /* Fix para cualquier bloque interno anidado que pudiera tener fondo */
        ...
        /* 8. BOTONES Y ENLACES (Se mantienen los colores) */
    ...
    with col_centro:
        ...
        with st.container(): 
            ...
            # --- VISTA NORMAL: LOGIN Y REGISTRO ---
                ...
                # El componente de tabs se ajustó para ser más plano
